...
public class Reporter : MonoBehaviour
{
	...
	public void Initialize()
	{
		...
		size.x = size.y = PlayerPrefs.GetFloat("Reporter_size", 24);
	...
	void initializeStyle()
	{
		...
		nonStyle.normal.textColor = Color.white * 0.8f;
		...
		lowerLeftFontStyle.normal.textColor = Color.white * 0.8f;
		...
		barStyle.normal.textColor = Color.white * 0.8f;
		...
		backStyle.normal.textColor = Color.white * 0.8f;
		...
		evenLogStyle.normal.textColor = Color.white * 0.8f;
		...
		oddLogStyle.normal.textColor = Color.white * 0.8f;
		...
		logButtonStyle.normal.textColor = Color.white * 0.8f;
		...
		stackLabelStyle.normal.textColor = Color.white * 0.8f;
		...
		toolbarScrollerSkin = GameObject.Instantiate(skin);
		...
		logScrollerSkin = GameObject.Instantiate(skin);
		...
		graphScrollerSkin = GameObject.Instantiate(skin);
